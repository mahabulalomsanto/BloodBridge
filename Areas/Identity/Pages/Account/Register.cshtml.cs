...
namespace BloodBridge.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.CanDonate = Input.CanDonate;
                //==================================================
                ...
                if (result.Succeeded)
                {
                    ...
                    if (!roleExist)
                    {
                        ...
                        {
                            // Handle the case where the role creation fails
                    ...
                    if (!adminRoleExist)
                    {
                        ...
                        if (!createAdminRoleResult.Succeeded)
                        {
                            ...
                            foreach (var error in createAdminRoleResult.Errors)
                            {
                                ModelState.AddModelError(string.Empty, error.Description);
                            }
                            return Page();
